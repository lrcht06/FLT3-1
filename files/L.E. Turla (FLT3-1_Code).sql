...
-- Insert Values to Courses Table --
...
-- Task 1 --
SELECT course_name, enrollment_limit, students_enrolled
FROM courses
WHERE students_enrolled<enrollment_limit;

-- Task 2 --
SELECT course_name, SUM(students_enrolled) as 'total number of students'
FROM courses
GROUP BY category;
...
-- Task 4 --
SELECT SUM(students_enrolled) AS 'total number of students enrolled in all courses'
FROM courses;
